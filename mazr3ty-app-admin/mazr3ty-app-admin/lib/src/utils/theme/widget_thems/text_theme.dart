...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.bold, color: TColors.secondary),
    headlineMedium: const TextStyle().copyWith(fontSize: 30, fontWeight: FontWeight.w600, color: TColors.secondary),
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: TColors.dark),

    titleLarge: const TextStyle().copyWith(fontSize: 35, fontWeight: FontWeight.w600, color: TColors.secondary),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: TColors.third),
  ...
  static TextTheme darkTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.bold, color: TColors.primary),
    headlineMedium: const TextStyle().copyWith(fontSize: 30, fontWeight: FontWeight.w600, color: TColors.primary),
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: TColors.light),

    titleLarge: const TextStyle().copyWith(fontSize: 35, fontWeight: FontWeight.w600, color: TColors.primary),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: TColors.third),
